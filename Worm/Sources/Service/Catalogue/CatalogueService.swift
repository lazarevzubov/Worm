...
final class CatalogueMockService: CatalogueService {
    ...
    private static let books = [Book(authors: ["J.R.R. Tolkien"],
                                ...
                                Book(authors: ["George R.R. Martin"],
                                     ...
                                     id: "4",
                                     similarBookIDs: ["4"]),
                                Book(authors: ["Frank Herbert"], title: "Dune I", id: "5", similarBookIDs: ["5"]),
                                Book(authors: ["Mikhail Bulgakov"],
                                     title: "The Master and Margarita",
                                     id: "6",
                                     similarBookIDs: ["6"]),
                                Book(authors: ["Alan Moore"], title: "Watchmen", id: "7", similarBookIDs: ["7"]),
                                ...
                                Book(authors: ["Martin Fowler"],
                                     ...
                                     id: "10",
                                     similarBookIDs: ["10"]),
                                Book(authors: ["Stephen King"], title: "The Shining", id: "11", similarBookIDs: ["11"]),
